...
FLAG_HAS_RETURN = 0b00100000
FLAG_FIXUP_RETURN = 0b01000000
...
def _read_flags(parser, prototype):
    ...
    prototype.flags.has_return = bool(bits & FLAG_HAS_RETURN)
    bits &= ~FLAG_HAS_RETURN
    
    if prototype.flags.has_return == True:
        return False

    prototype.flags.fixup_return = bool(bits & FLAG_FIXUP_RETURN)
    bits &= ~FLAG_FIXUP_RETURN

    if prototype.flags.fixup_return == True:
        return False
